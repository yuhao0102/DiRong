...
contains
    ...
    subroutine register_component_coupling_configuration
        ...
        integer          :: field_id_psl, field_id_prect, field_id_flds, field_id_flds2, field_id_fsds
...
!        grid_h2d_id = CCPL_register_H2D_grid_via_global_data(ocn_demo_comp_id, "ocn_demo_H2D_grid", "LON_LAT", "degrees", "cyclic", lonlen, latlen, 0.0, 360.0, -90.0, 90.0, lon, lat, mask, annotation="register ocn_demo H2D grid ")
        grid_h2d_id = CCPL_register_H2D_grid_via_global_data(ocn_demo_comp_id, "ocn_demo_H2D_grid", "LON_LAT", "degrees", "cyclic", lonlen, 0, 0.0, 360.0, -90.0, 90.0, lon, lat, mask, annotation="register ocn_demo H2D grid ")
        ...
        field_id_flds2  = CCPL_register_field_instance(flds(1:decomp_size), "flds2", decomp_id, grid_h2d_id, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="W/m2", annotation="register field instance of Long wave downward flux at surface")
        ...
        field_id_mld2 = CCPL_register_field_instance(mldm, "mld2", decomp_id, grid_h2d_id, 0, usage_tag=CCPL_TAG_CPL_REST, field_unit="m", annotation="register field instance of Mixed layer depth")
        ...
        export_interface_id = CCPL_register_export_interface("send_data_to_atm", 5, fields_id, timer_id, annotation="register interface for sending data to atmosphere")
        ...
        import_interface_id = CCPL_register_import_interface("receive_data_from_atm", 5, fields_id, timer_id, 0, annotation="register interface for receiving data from atmosphere")
