...
! !PUBLIC DATA MEMBERS:
      ...
      real, public :: time_in_SparseMatrixPlus(2)
! !DEFINED PARAMETERS:
...
!
  ...
  case(Xonly)
     ...
     time_in_SparseMatrixPlus(1) = time(2) - time(1)
     ...
     time_in_SparseMatrixPlus(2) = time(2) - time(1)
!     print *, "time_in_SparseMatrixPlus", time_in_SparseMatrixPlus
